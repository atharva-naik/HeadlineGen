...
class TransformerDataProcessor():
    def __init__(self, args):
        self.args = args 
        self.tokenizer = AutoTokenizer.from_pretrained(args.bert_path, do_lower_case=False)
        self.sep = '[SEP]'
        self.cls = '[CLS]'
        self.pad = '[PAD]'
...
class BertData():
    def __init__(self, args):
        self.args = args
        self.tokenizer = BertTokenizer.from_pretrained(args.bert_path, do_lower_case=True)
